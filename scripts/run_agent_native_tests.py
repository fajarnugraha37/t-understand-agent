...
d={'status':'PASS' if r.wasSuccessful() else 'FAIL','tests':r.testsRun,'failures':len(r.failures),'errors':len(r.errors),'categories':{'greeting':1,'intent_precedence':2,'artifact_documentation':1,'response_sanitation':1}}
