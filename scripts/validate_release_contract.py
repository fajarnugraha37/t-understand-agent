...
if version!='1.0.2':errors.append('VERSION must be 1.0.2')
...
for name in ('phase-16-assurance.md','phase-17-assurance.md','phase-18-assurance.md','phase-19-assurance.md','phase-20-assurance.md','tool-permissions-and-skill-namespace.md','agent-native-workflow.md'):
 checks+=1
