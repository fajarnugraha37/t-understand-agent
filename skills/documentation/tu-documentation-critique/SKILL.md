---
name: tu-documentation-critique
description: Execute the t-understand documentation critique workflow with evidence-first, schema-bound, read-only behavior.
...
Challenge documentation completeness and truthfulness.
