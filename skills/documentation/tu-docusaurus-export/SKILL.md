---
name: tu-docusaurus-export
description: Execute the t-understand docusaurus export workflow with evidence-first, schema-bound, read-only behavior.
...
Export MDX and sidebar configuration for Docusaurus.
