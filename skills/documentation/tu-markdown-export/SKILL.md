---
name: tu-markdown-export
description: Execute the t-understand markdown export workflow with evidence-first, schema-bound, read-only behavior.
...
Export canonical documents as portable Markdown.
