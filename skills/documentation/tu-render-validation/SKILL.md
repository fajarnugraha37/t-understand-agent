---
name: tu-render-validation
description: Execute the t-understand render validation workflow with evidence-first, schema-bound, read-only behavior.
...
Validate Markdown, MDX, links, diagrams, and renderer output.
