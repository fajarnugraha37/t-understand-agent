---
name: tu-mintlify-export
description: Execute the t-understand mintlify export workflow with evidence-first, schema-bound, read-only behavior.
...
Export MDX and docs.json for Mintlify-compatible presentation.
