---
name: tu-documentation-traceability
description: Execute the t-understand documentation traceability workflow with evidence-first, schema-bound, read-only behavior.
...
Bind sections to claims and evidence.
