---
name: tu-mkdocs-export
description: Execute the t-understand mkdocs export workflow with evidence-first, schema-bound, read-only behavior.
...
Export Markdown and navigation configuration for MkDocs.
