---
name: tu-model-verification
description: Execute the t-understand model verification workflow with evidence-first, schema-bound, read-only behavior.
...
Verify model schemas, provenance, digest integrity, and reference closure.
