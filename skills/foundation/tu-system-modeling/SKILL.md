---
name: tu-system-modeling
description: Execute the t-understand system modeling workflow with evidence-first, schema-bound, read-only behavior.
...
Construct application and system models.
