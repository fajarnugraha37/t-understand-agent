---
name: tu-model-critique
description: Execute the t-understand model critique workflow with evidence-first, schema-bound, read-only behavior.
...
Challenge model support, classifications, conflict handling, and completeness.
