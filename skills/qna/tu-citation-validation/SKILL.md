---
name: tu-citation-validation
description: Execute the t-understand citation validation workflow with evidence-first, schema-bound, read-only behavior.
...
# tu-citation-validation

## Purpose

Validate answer citations and snapshot consistency.
