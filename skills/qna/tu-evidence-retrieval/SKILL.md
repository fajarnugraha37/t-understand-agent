---
name: tu-evidence-retrieval
description: Execute the t-understand evidence retrieval workflow with evidence-first, schema-bound, read-only behavior.
...
# tu-evidence-retrieval

## Purpose

Retrieve claims and direct evidence.
