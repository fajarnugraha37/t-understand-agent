---
name: tu-answer-synthesis
description: Execute the t-understand answer synthesis workflow with evidence-first, schema-bound, read-only behavior.
...
Produce cited structured answer.
