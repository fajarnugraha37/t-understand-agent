---
name: tu-direct-source-verification
description: Execute the t-understand direct source verification workflow with evidence-first, schema-bound, read-only behavior.
