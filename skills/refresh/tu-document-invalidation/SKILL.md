---
name: tu-document-invalidation
description: Execute the t-understand document invalidation workflow with evidence-first, schema-bound, read-only behavior.
...
Mark dependent document sections stale.
