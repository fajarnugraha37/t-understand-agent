---
name: tu-model-reconciliation
description: Execute the t-understand model reconciliation workflow with evidence-first, schema-bound, read-only behavior.
