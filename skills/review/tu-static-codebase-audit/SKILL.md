---
name: tu-static-codebase-audit
description: Execute the t-understand static codebase audit workflow with evidence-first, schema-bound, read-only behavior.
...
# tu-static-codebase-audit

## Purpose

Audit one complete snapshot with coverage ledger.
