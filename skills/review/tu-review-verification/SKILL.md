---
name: tu-review-verification
description: Execute the t-understand review verification workflow with evidence-first, schema-bound, read-only behavior.
...
# tu-review-verification

## Purpose

Validate finding locations, evidence, severity, and coverage.
