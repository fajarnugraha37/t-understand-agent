---
name: tu-impact-tracing
description: Execute the t-understand impact tracing workflow with evidence-first, schema-bound, read-only behavior.
...
Trace affected callers, contracts, data, events, and repositories.
