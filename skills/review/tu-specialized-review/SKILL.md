---
name: tu-specialized-review
description: Execute the t-understand specialized review workflow with evidence-first, schema-bound, read-only behavior.
...
# tu-specialized-review

## Purpose

Perform correctness, security, concurrency, data, performance, and compatibility review.
