---
name: tu-severity-calibration
description: Execute the t-understand severity calibration workflow with evidence-first, schema-bound, read-only behavior.
...
# tu-severity-calibration

## Purpose

Calibrate surviving findings.
