---
name: tu-review-export
description: Execute the t-understand review export workflow with evidence-first, schema-bound, read-only behavior.
...
Export canonical review artifacts and platform comments.
