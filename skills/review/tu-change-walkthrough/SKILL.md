---
name: tu-change-walkthrough
description: Execute the t-understand change walkthrough workflow with evidence-first, schema-bound, read-only behavior.
...
# tu-change-walkthrough

## Purpose

Produce CodeRabbit-style walkthrough.
