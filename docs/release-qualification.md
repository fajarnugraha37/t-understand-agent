...
Phase 20 is the final release gate; v1.1.0 requalifies the complete v1.0.0 platform after agent-native UX, installer, namespace, and permission hardening. It does not implement another analysis capability; it proves that the complete source tree, registries, reports, adapters, and package are coherent.

## Release gates

- `VERSION` is exactly `1.1.0`;
...
CHECKSUMS.sha256
t-understand-v1.1.0-multi-repo-deep-documentation-bundle.zip
```
